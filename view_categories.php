...
<body>
    ...
    <div class="main-content">
        ...
        <h2 class="text-center">View Asset Details</h2>
                <div class="card">
                <img src="images/<?php echo $category->image; ?>" alt="dp" class="w-70%">

                    <div class="card-body">
                        <h5 class="card-title fw-bolder"><?php echo ucfirst($category->name); ?></h5>
                    </div>
                    <div class="card-footer">
                        <a href="update_asset.php?id=<?php echo $category['id']; ?>" class="btn btn-primary">Edit</a>
                        <form action="./server/handler.php" method="POST" class="d-inline-block">
                            <input type="hidden" name="assetdelete" value="<?php echo $category['id']; ?>">
