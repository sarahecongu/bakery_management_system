...
// Create
if (isset($_POST['add_cake_category'])) {
  $data = [
    'name' => $_POST['name']
  ...
  header("Location: cake_category_table.php");
  exit();
}
// Delete
if (isset($_POST['cake_category_delete'])) {
  $category_id = $_POST['cake_category_delete'];
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <!-- form -->
          <!-- firstname -->
          <form action="cake_category_table.php" method="POST" enctype="multipart/form-data">
            <div class="mb-3">
            ...
            <div class="modal-footer">
              ...
              <button type="submit" class="bt" name = "add_cake_category">Add Category</button>
            </div>
        </div>
      </div>
    </div>
  ...
  <table class="table table-striped mt-3">
    ...
    <?php foreach ($searchedCategories as $category): ?>
        <tr>
          ...
          <td>
            <a href="view_cake_categories.php?id=<?php echo $category->id; ?>" class="btn btn-primary btn-sm mr-3" title="view"><i class="fas fa-eye"></i></a>
