...
if (isset($_POST['add_promotion'])) {
  $data = [
    ...
    'promotions_id'=> $_POST['promotions_id'],
        ...
        <div class="modal-body">
          ...
          <form action="product_table.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
              ...
              <!-- price -->
              <div class="mb-3">
              <label class="form-label">promotions Id</label>
              <input type="text" class="form-control" name="promotions_id" placeholder="product price">
            </div>
               <!-- price -->
               <div class="mb-3">
            ...
            <div class="modal-footer">
              ...
              <button type="submit" class="bt" name = "add_promotion">Add product</button>
            </div>
        </div>
      </div>
    </div>
  ...
  <table class="table table-striped mt-3">
    ...
    <tbody>
      <?php foreach ($products->all() as $product): 
                $promotions_details = $promotions->getParentAttributesFromChild('products', 'product_categories', $product->id, 'promotions_id');
        ...
        <tr>
          ...
          <td>
            <?php echo $promotions_details->name ?? NULL; ?>
          </td>
          <td> 
